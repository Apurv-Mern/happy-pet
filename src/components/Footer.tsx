          ...
          <div className="pl-0 md:pl-10">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2 opacity-90">
                ...
                <path d="M22.0221 12.5841C22.0221 10.612 21.4044 8.68956 20.2557 7.08661C19.1071 5.48366 17.4852 4.28077 15.6178 3.64689C13.7504 3.013 11.7314 2.97996 9.84433 3.55241C7.95722 4.12486 6.29683 5.27403 5.09634 6.83854C3.89585 8.40305 3.21557 10.3043 3.15105 12.2753C3.08653 14.2462 3.641 16.1879 4.73659 17.8276C5.83219 19.4672 7.41387 20.7226 9.25949 21.4172C11.1051 22.1118 13.122 22.2109 15.0268 21.7005" stroke="white" stroke-width="2" stroke-linecap="round"/>
                <circle cx="12.5839" cy="12.5841" r="4.19469" stroke="white" stroke-width="2"/>
                <path d="M16.7788 9.43805V14.1571C16.7788 15.605 17.9526 16.7788 19.4005 16.7788C20.8484 16.7788 22.0222 15.605 22.0222 14.1571V12.5841" stroke="white" stroke-width="2" stroke-linecap="round"/>
                </svg>
                <a href={`mailto:${footerData.contact.email}`} className="hover:underline">
              ...
              <li className="flex items-center gap-2 opacity-90">                
                ...
                <a href={`tel:${footerData.contact.phone}`} className="hover:underline">
            ...
            <div className="flex items-center gap-4 mt-6">
              {footerData.social.map(social => (
                <SocialIcon key={social.label} svg={social.svg} label={social.label} href={social.href} />
              ))}
            </div>
          </div>
        </div>
