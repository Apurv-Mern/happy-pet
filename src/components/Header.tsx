...
export function Header() {
  ...
  return (
    <header className="w-full">
      {/* Top dark band */}
      <motion.div
        className="bg-[#0E213A] text-white hidden xl:block"
        ...
        <div className="container mx-auto ">
          {isAuthenticated ? (
            ...
            <>
              ...
              <div className="flex items-center justify-between pt-10 xl:pt-16 xl:px-4">
                <Link to="/">
                  <div>
              ...
              <div className="flex justify-center mt-6">
                <nav className="hidden xl:flex items-center justify-center text-sm font-medium bg-white backdrop-blur-sm rounded-full py-[5px] px-[5px] max-w-fit ">
          ...
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="fixed inset-0 bg-black/50 z-40 xl:hidden h-svh"
            />
          )}
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 h-svh w-[280px] sm:w-[320px] bg-white shadow-2xl z-50 xl:hidden overflow-y-auto"
          >
            <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row items-center gap-6 sm:gap-0 lg:gap-0 xl:mt-6">
