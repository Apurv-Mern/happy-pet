        ...
        <div className="">
          ...
          <div className="">
            {isViewingProductLine ? (
              ...
              // Product Lines Grid
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 pt-10">
                {productLines.map((productLine, index) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6">
                      <h3 className="text-white text-[16px] sm:text-[18px] md:text-[24px] font-semibold">
                        {productLine.name}
                      </h3>
                    </div>
