              ...
              {premiumTiers.map((tier, index) => (
                ...
                >
                  ...
                  <div className="relative h-full overflow-hidden">
                    ...
                    /> */}
                    {/* Dark Overlay */}
                    <img className="h-full max-h-[550px] object-cover w-full rounded-[20px] border-[2px] border-[#003863]" src="/assets/images/dog.png" alt="" />
                  </div>
