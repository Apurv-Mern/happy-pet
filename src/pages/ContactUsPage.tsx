            ...
            <div className="grid grid-cols-1 md:grid-cols-[30%_66%] gap-[60px]">
              ...
              <div className="bg-[#003863] text-white p-8 relative overflow-hidden rounded-[10px]">
                ...
                <div className="flex gap-4 absolute bottom-[30px]">
                  ...
                  <span className="cursor-pointer">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.8195 2.16296H24.652L16.2791 11.7326L26.1291 24.7547H18.4166L12.376 16.8568L5.46408 24.7547H1.62928L10.5849 14.5189L1.13574 2.16296H9.04399L14.5042 9.38188L20.8195 2.16296ZM19.4744 22.4607H21.598L7.89008 4.3364H5.61121L19.4744 22.4607Z" fill="white"/>
                    </svg>
                  </span>
                  <span className="cursor-pointer">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M13.6326 6.63C9.76648 6.63 6.62988 9.7666 6.62988 13.6328C6.62988 17.4989 9.76648 20.6355 13.6326 20.6355C17.4988 20.6355 20.6354 17.4989 20.6354 13.6328C20.6354 9.7666 17.4988 6.63 13.6326 6.63ZM13.6326 18.1752C11.1244 18.1752 9.09017 16.141 9.09017 13.6328C9.09017 11.1246 11.1244 9.09029 13.6326 9.09029C16.1409 9.09029 18.1751 11.1246 18.1751 13.6328C18.1751 16.141 16.1409 18.1752 13.6326 18.1752Z" fill="white"/>
                    <path d="M22.5471 6.35301C22.5471 7.25831 21.8122 7.98787 20.9122 7.98787C20.0069 7.98787 19.2773 7.25298 19.2773 6.35301C19.2773 5.44771 20.0122 4.71814 20.9122 4.71814C21.8122 4.71814 22.5471 5.45303 22.5471 6.35301Z" fill="white"/>
                    </g>
                    <defs>
              ...
              <div className="pt-10">
                ...
                {/* Select Subject */}
                <div className="mb-6">
                  <label className="text-sm font-semibold text-[#003863] mb-6 block">Select Subject?</label>
                ...
                <img className="relative left-[200px] bottom-[58px]" src="/assets/images/letter.png" alt="" />
              </div>
            </div>
          </div>
      </div>
