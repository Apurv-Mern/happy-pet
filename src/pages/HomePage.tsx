...
export function HomePage() {
  return (
    ...
    >
      <div className="bg-[url('/assets/images/pet-image.png')] bg-cover bg-center h-[120px] sm:h-[150px] md:h-[190px] w-full">
      ...
      >
        <div className="relative max-w-[610px] w-full bg-[url('/assets/images/curve-border.png')] bg-no-repeat bg-contain bg-center text-center pt-0 py-8 sm:py-10 md:py-12 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-auto pb-8 sm:pb-10 md:pb-14">
          <div className="text-center md:text-end">
            <img
              ...
              className="w-full max-w-[300px] sm:max-w-[400px] md:max-w-[500px] mx-auto md:mx-0 md:ml-auto"
              alt=""
            />
          </div>
          <div>
