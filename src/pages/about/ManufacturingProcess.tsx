        ...
        <div className="bg-[#E3E6ED] py-10">
          <div className="container mx-auto">
            ...
            <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px] text-center font-semibold">
              ...
              ingredients to the delicious dry food.
            </p>
            ...
            <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px] text-center font-semibold">
              ...
              gentle preparation with the Thermostufenmix®. This is how tasty
              Happy Dog dry food of the highest quality is produced in
              Wehringen, Bavaria.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[40%_60%] xl:grid-cols-[40%_60%] 2xl:grid-cols-[40%_60%] items-center">
            ...
            <div>
              ...
              <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px] mt-5">
                ...
                extremely important to us when it comes to our meat suppliers.
                We also attach great importance to sourcing as many of the
                plant-based raw materials as possible, such as grain, potatoes
                and local herbs, from predominantly regional agriculture.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[60%_40%] xl:grid-cols-[60%_40%] 2xl:grid-cols-[60%_40%] items-center">
              <div>
                ...
                <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px] mt-5">
                  ...
                  protect the environment and support the farmers in our
                  homeland.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[40%_60%] xl:grid-cols-[40%_60%] 2xl:grid-cols-[40%_60%] items-center">
            ...
            <div>
              ...
              <p className="text-[#003863] sm:text-[16px] md:text-[20px] mt-5">
                ...
                ground and mixed in a mill. This process takes around 4 minutes.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[40%_60%] xl:grid-cols-[40%_60%] 2xl:grid-cols-[40%_60%] items-center">
            ...
            <div>
              ...
              <p className="text-[#003863] sm:text-[16px] md:text-[20px] mt-5">
                ...
                refined with high-quality oils and antioxidants and cooled to
                ambient temperature.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[60%_40%] xl:grid-cols-[60%_40%] 2xl:grid-cols-[60%_40%] items-center">
              <div>
                ...
                <p className="text-[#003863] sm:text-[16px] md:text-[20px] mt-5">
                  ...
                  laboratory. Only when we are completely sure that our premium
                  dog food has been produced in the best quality using natural
                  ingredients and the perfect recipe, are the croquettes packed
