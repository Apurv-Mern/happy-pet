        ...
        <div className="bg-[#E3E6ED] py-10">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-[40%_60%]  2xl:grid-cols-[40%_60%] items-center">
              ...
              <div>
                ...
                <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px]">
                  ...
                  species-appropriate support for the metabolism and the entire
                  organism - nutritionally proven based on the model of nature.
                </p>
              </div>
            </div>
            <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px] md:mt-3">
              ...
              linseed or seaweed. In order to support the metabolism optimally
              and in a species-appropriate manner, natural products with
              health-promoting properties are irreplaceable. This way, your dog
              is provided with everything that the organism benefits from in its
              entirety - from a strong immune system to a healthy coat! Of
              course, we select the healthy natural ingredients for our  premium
              dog food  specifically based on whether they have a positive
              effect on the health of your furry friend and combine them to
              create an optimal nutrient mix. This way, you can be sure that
              your dog is neither over- nor under-supplied and that no
        ...
        <div className="bg-[#E3E6ED] py-10">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 xl:grid-cols-[70%_30%]">
              <div>
                ...
                <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px]">
                  ...
                  these substances and is supplemented by a variety of healthy
                  ingredients from nature. We take nature as our model and
                  refine our dog food recipes with healthy herbs from the
                  region. For every Happy Dog food you will find precise
                  information on the composition on the packaging or on our
                  website, which tells you which ingredients are contained in
                ...
                <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px]">
                  ...
                  rice, barley, oils and fats, fish meal (5%, of which 50%
                  salmon meal), hemoglobin*, hydrolysed protein, beet molasses
                  pulp* (desugared), apple pomace*, potassium chloride, yeast*,
                  sodium chloride, seaweed*, linseed (0.16%), dried whole egg
                  (0.12%), milk thistle, mussel meat* (0.02%), yeast*
                  (extracted), artichoke, dandelion, ginger (0.016%), birch
                  leaves, nettle, chamomile, coriander, rosemary, sage,
            ...
            <p className="text-[#003863] text-[16px] sm:text-[16px] md:text-[20px] md:mt-3">
              ...
              antioxidant effect. In addition, the meat of the green-lipped
              mussel is rich in glycosaminoglycans and is therefore good for the
              joints , and the ginger it contains supports the immune system.{' '}
              <br></br>With our healthy, whole foods, your four-legged friend is
              well looked after. Depending on your dog's special needs, you can
              choose the right food from our range. If you are unsure about
              choosing the right food, our nutrition experts will be happy to
              give you advice on food.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2">
              <div>
                ...
                <p className="text-[16px] sm:text-[16px] md:text-[20px] text-[#fff] font-bold">
                  ...
                  that dogs need. This way, your darling will stay fit and
