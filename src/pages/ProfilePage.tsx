...
const ProfilePage = () => {
  ...
  useEffect(() => {
    if (profileImage && shouldAutoSave.current) {
      handleSaveChanges()
      ...
      icon: (
        ...
        >
          <path
            ...
            fill={activeSection === 'personal' ? '#fff' : '#003863'}
          />
        </svg>
      ),
